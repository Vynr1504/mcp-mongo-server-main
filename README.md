...
npx -y mcp-mongo-server mongodb://vynr:1504@localhost:27017/database

# Connect in read-only mode
npx -y mcp-mongo-server mongodb://vynr:1504@localhost:27017/database --read-only
```
...
export MCP_MONGODB_URI="mongodb://vynr:1504@localhost:27017/database"
...
```json
{
  "mcpServers": {
    "mongodb-env": {
      ...
      "env": {
        "MCP_MONGODB_URI": "mongodb://vynr:1504@localhost:27017/database",
...
# Run
docker run -it -d -e MCP_MONGODB_URI="mongodb://vynr:1504@localhost:27017/database" -e MCP_MONGODB_READONLY="true" mcp-mongo-server
